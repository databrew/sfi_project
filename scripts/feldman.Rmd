...
#
# there are two columns, (1) federal, a dummy variable indicating whether its "state" or "federal" govt and (2) clarity index which is a vector of clarity scores
# need to make an overlapping density plotwith ggplot and custom theme
